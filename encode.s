@Project 3 Part 1 - Encryption
@Comp 122 TR 4pm Team 2

.global	Encrypt	  		@Declares Encrpyt for use outside this file
...
Encrypt:	@place to start from for external file
...
loop:							@Processes a single char then loops back
	...
	ADD	r4,r9,r4		@Add encrypt value to current char
	ADD	r5,r5,#1		@Increment array index
	CMP	r4,#126			@Upper end of ASCII table
	BLE	addtoarray
	SUB	r4,r4,#95
...
InputFileName:		.asciz	"encrypt-in.txt"
OutputFileName:		.asciz	"encrypt-out.txt"
...
EncodeArray:		.skip	85
	.align
TitleText:		.asciz	"    Encryption:"
Options0:		.asciz  "Ensure that encrypt-in.txt exists"
